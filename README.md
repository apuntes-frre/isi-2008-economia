...
- 🗂️ **Bloque:** Complementarias
- ⏱️ **Horas semanales:** 3

## 🔗 Correlativas

**Para cursar — cursadas:** Análisis de Sistemas
**Para cursar — aprobadas:** Sistemas y Organizaciones, Algoritmos y Estructuras de Datos
**Para rendir — aprobadas:** Análisis de Sistemas
